...
class Sprig_Node_AssignTest extends Sprig_Node_AbstractTest {
    function testCompile() {
        ...
        $node = new Sprig_Node_Smarty_Assign('assign', array('var' => $this->_expr('test'), 'value' => $this->_expr($value)), null);
    ...
    function testNotSetVarThrowsSyntaxError() {
        $o = new Sprig_Node_Smarty_Assign('assign', array(), null);
    ...
    function testInvalidTypeThrowsSyntaxError() {
        $o = new Sprig_Node_Smarty_Assign('assign', array('var' => new Twig_Node_Expression_Name('test', null)), null);
        $o->compile($this->compiler);
    }
}